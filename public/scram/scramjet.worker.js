(()=>{var e={8810:function(e,t,r){r.d(t,{Sp:()=>s,h3:()=>n,t8:()=>o}),"$scramjet"in self||(self.$scramjet={version:{build:"4d98195",version:"1.0.2-dev"},codec:{},flagEnabled:s});let n=self.$scramjet,i=Function;function o(){n.codec.encode=i(`return ${n.config.codec.encode}`)(),n.codec.decode=i(`return ${n.config.codec.decode}`)()}function s(e,t){let r=n.config.flags[e];for(let r in n.config.siteFlags){let i=n.config.siteFlags[r];if(new RegExp(r).test(t.href)&&e in i)return i[e]}return r}},4471:function(e,t,r){r.d(t,{$O:()=>m,Ag:()=>d,KF:()=>o,Sd:()=>c,U5:()=>u,V6:()=>p,r4:()=>g});var n=r(8810);let{util:{BareClient:i,ScramjetHeaders:o,BareMuxConnection:s},url:{rewriteUrl:a,unrewriteUrl:c,rewriteBlob:l,unrewriteBlob:d},rewrite:{rewriteCss:u,unrewriteCss:f,rewriteHtml:g,unrewriteHtml:h,rewriteSrcset:w,rewriteJs:b,rewriteHeaders:p,rewriteWorkers:m,htmlRules:_},CookieStore:y}=n.h3.shared;n.h3.config},4079:function(e,t,r){r.d(t,{L:()=>s});var n=r(8810),i=r(522);Error.stackTraceLimit=50;let o=new TextDecoder;function s(e,t,r,a=!1){return function(e,t,r,s=!1){if((0,n.Sp)("naiiveRewriter",r.origin)){var a;return{js:("string"!=typeof(a="string"==typeof e?e:new TextDecoder().decode(e))&&(a=new TextDecoder().decode(a)),`
		with (${n.h3.config.globals.wrapfn}(globalThis)) {

			${a}

		}
	`),tag:"",map:null}}return function(e,t,r,s){let[a,c]=(0,i.p)(r);try{let i,c=performance.now();try{i="string"==typeof e?a.rewrite_js(e,r.base.href,t||"(unknown)",s):a.rewrite_js_bytes(e,r.base.href,t||"(unknown)",s)}catch(r){return console.warn("failed rewriting js for",t,r.message,e),{js:e,tag:"",map:null}}let l=performance.now(),{js:d,map:u,scramtag:f,errors:g}=i,h=l-c;if((0,n.Sp)("sourcemaps",r.base)&&!globalThis.clients&&(globalThis[globalThis.$scramjet.config.globals.pushsourcemapfn](Array.from(u),f),u=null),(0,n.Sp)("rewriterLogs",r.base))for(let e of g)console.error("oxc parse error",e);(0,n.Sp)("rewriterLogs",r.base)&&console.log(`oxc rewrite for "${t||"(unknown)"}" was ${h<1?"BLAZINGLY FAST":h<500?"decent speed":"really slow"} (${h}ms)`);return{js:"string"==typeof e?o.decode(d):d,tag:f,map:u}}finally{c()}}(e,t,r,s)}(e,t,r,a)}},522:function(e,t,r){r.d(t,{V:()=>o,p:()=>c});var n=r(7418),i=r(8810);async function o(){let e=await fetch(i.h3.config.files.wasm).then(e=>e.arrayBuffer());self.REAL_WASM=new Uint8Array(e)}self.WASM&&(self.REAL_WASM=Uint8Array.from(atob(self.WASM),e=>e.charCodeAt(0)));let s=new TextDecoder,a="\0asm".split("").map(e=>e.charCodeAt(0));function c(e){let t;if(!(self.REAL_WASM&&self.REAL_WASM instanceof Uint8Array))throw Error("rewriter wasm not found (was it fetched correctly?)");if(![...self.REAL_WASM.slice(0,4)].every((e,t)=>e===a[t]))throw Error("rewriter wasm does not have wasm magic (was it fetched correctly?)\nrewriter wasm contents: "+s.decode(self.REAL_WASM));(0,n.rb)({module:new WebAssembly.Module(self.REAL_WASM)}),i.h3.shared.rewriter||(i.h3.shared.rewriter=[]);let r=i.h3.shared.rewriter.findIndex(e=>!e.inUse),o=i.h3.shared.rewriter.length;return -1===r?((0,i.Sp)("rewriterLogs",e.base)&&console.log(`creating new rewriter, ${o} rewriters made already`),t={rewriter:new n.mZ(i.h3),inUse:!0},i.h3.shared.rewriter.push(t)):((0,i.Sp)("rewriterLogs",e.base)&&console.log(`using cached rewriter ${r} from list of ${o} rewriters`),t=i.h3.shared.rewriter[r]),[t.rewriter,()=>t.inUse=!1]}},4155:function(e,t,r){r.d(t,{O:()=>i});var n=r(8810);function i(e,t){let r={"content-type":"text/html"};return crossOriginIsolated&&(r["Cross-Origin-Embedder-Policy"]="require-corp"),new Response(function(e,t){let r=`
